...
import com.paginatedtable.model.common.util.FilterResolutionStrategy;
import com.paginatedtable.model.common.util.FilterResolutionStrategyFactory;
...
public abstract class TableFilterRepositoryImpl<E, D, Id> implements TableFilterRepository {
    ...
    private void filterWithoutFields(List<E> filteredList, String completeFilter,
        ...
        Query query = this.getNativeQueryForAllFields(entityManager, completeFilter, sortPart.toString());
        List result = (List<E>) query.getResultList();
    ...
    protected abstract Query getNativeQueryForAllFields(EntityManager entityManager, String completeFilter, String sort);
