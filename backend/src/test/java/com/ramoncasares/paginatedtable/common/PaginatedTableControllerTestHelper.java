...
import com.ramoncasares.paginatedtable.common.util.UserTypeEnum;
import com.ramoncasares.paginatedtable.common.util.UserTypeRequestFactory;
...
public final class PaginatedTableControllerTestHelper {
    ...
    public static ResultActions tryHTTPRequestWithUserTypeToAnalyseResult(final MockMvc mockMvc, final String urlTest, final HttpMethod httpMethod,
                                                                          final UserTypeEnum userType) {
        return tryHTTPRequestWithUserTypeToAnalyseResult(mockMvc, urlTest, httpMethod, userType, null);
    }

    public static ResultActions tryHTTPRequestWithUserTypeToAnalyseResult(final MockMvc mockMvc, final String urlTest, final HttpMethod httpMethod,
                                                                          final UserTypeEnum userType, String requestEntityJson) {
        IUserTypeRequest userTypeRequest = UserTypeRequestFactory.getHttpRequest(userType);
